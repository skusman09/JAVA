...
public class _01_ArrayList {
    public static void main(String[] args) {
        ...
        // Use the Arrays Class And ite methods
        colors2.addAll(Arrays.asList("orange", "kiwi"));
        System.out.println("->>>>>>>>>>" + colors2);
        colors2.addAll(2, Arrays.asList("orange", "kiwi"));
        System.out.println("->>>>>>>>>> with index" + colors2);
        ...
        System.out.println(colors2.get(4));

        colors2.remove(String.valueOf("Green"));
    }
}